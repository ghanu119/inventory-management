    ...
    <form action="{{ route('products.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Enter product name">
            </div>

            <div>
                <label for="sku" class="block text-sm font-semibold text-gray-700 mb-2">SKU <span class="text-red-500">*</span></label>
                <input type="text" name="sku" id="sku" value="{{ old('sku') }}" required placeholder="Enter SKU code">
            </div>

            <div>
                <label for="hsn_code" class="block text-sm font-semibold text-gray-700 mb-2">HSN Code</label>
                <input type="text" name="hsn_code" id="hsn_code" value="{{ old('hsn_code') }}" placeholder="Enter HSN code">
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="price" class="block text-sm font-semibold text-gray-700 mb-2">Price <span class="text-red-500">*</span></label>
                    <input type="number" step="0.01" name="price" id="price" value="{{ old('price') }}" required min="0" placeholder="0.00">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="gst_rate" id="gst_rate" value="{{ old('gst_rate', 0) }}" required min="0" max="100" placeholder="0.00">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.01" name="warranty_years" id="warranty_years" value="{{ old('warranty_years') }}" min="0" placeholder="e.g. 1 or 1.5">
            </div>

            <div>
                <label for="custom_short_text" class="block text-sm font-semibold text-gray-700 mb-2">Custom short text for product</label>
                <textarea name="custom_short_text" id="custom_short_text" rows="3" placeholder="Optional short description or note (multiline)">{{ old('custom_short_text') }}</textarea>
            </div>
